...
EcoSense is a full-stack IoT project that streams sensor data from an ESP32 to a browser-based dashboard over USB Serial (Web Serial API). No server, no cloud — just plug in and monitor.
